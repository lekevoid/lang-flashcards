<template>
	...
	>
		<div
			class="cover heads bg-dark flex column flex-center q-pa-xl shadow-5"
		>
			<p class="q-ma-none">{{ card.term }}</p>
		</div>
		<div
			class="cover tails bg-dark flex column flex-center q-pa-xl shadow-5"
		>
			<p
				class="q-ma-none"
				v-for="(t, k) in card.translations"
				:key="card.id + k"
			>
				{{ t }}
			</p>
